...
5. **문의처 안내 시 반드시 아래 연락처를 그대로 사용하세요 (홈페이지 참고 안내 금지)**:
${contactInfo}
...
- **답변 마지막에 반드시 위의 연락처 정보(전화번호, 이메일, 위치, 업무시간)를 그대로 복사하여 포함**
...
1. 명확하고 구체적인 답변
2. 관련 규정이나 절차 안내
3. **답변 마지막에 반드시 위의 연락처 정보(전화번호, 이메일, 위치, 업무시간)를 그대로 복사하여 포함**
